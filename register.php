...
Unter der class all wird das Formular gestylt zum Registriernen.
Das gesamte html-tag wird gestylt mit dem Hintergrundbild. -->
    <style>
        .all {
            position: absolute;
            top: 40%;
...
//Überprüfung ob es Eingaben gibt
    if(isset($_GET['register'])) {
        ...
        //Überprüfung ob email schon vergeben ist
        if (!$error) {
            $email = $_POST['eMail'];
        ...
        //Daten werden an die Datenbank übergeben 
...
//Neuer Eintrag in die Datenbank für das Profilbild, indem man direkt ein Musterbild bekommt wenn man noch keins hat. 
        if ($result > 0) {
