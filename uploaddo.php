...
<?php
    ...
    $only_name = $namearray[0];
            ...
            if ($file !== false) {
                echo "Dieser Dateiname existiert bereits<br><br><a href=upload.php><button id='upload'>Zurück zum Upload</button></a><a href=index.php><button id='upload'>Zurück zur Startseite</button></a>";
                die();
        }

if (isset($namearray[2])){
    echo "Ungültiger Dateiname, bitte keine Punkte im Dateiname<br><br><a href=upload.php><button id='upload'>Zurück zum Upload</button></a><a href=index.php><button id='upload'>Zurück zur Startseite</button></a>";
    die();
}

if($_FILES["uploadfile"]["name"]=="")
{
    echo "Es wurde keine Datei ausgewählt<br><br><a href=upload.php><button id='upload'>Zurück zum Upload</button></a><a href=index.php><button id='upload'>Zurück zur Startseite</button></a>";
    die();
}


if ($_FILES["uploadfile"]["size"] > 25000000) {
    echo"Datei zu groß<br><br><a href=upload.php><button id='upload'>Zurück zum Upload</button></a><a href=index.php><button id='upload'>Zurück zur Startseite</button></a>";
    die();
}
if(!$error) {
    if ($namearray[1] == "jpg" OR $namearray[1] == "png" OR $namearray[1] == "PNG" OR $namearray[1] == "JPG" OR $namearray[1] == "jpeg" OR $namearray[1] == "gif" OR $namearray[1] == "pdf" OR $namearray[1] == "gif" OR $namearray[1] == "pdf" OR $namearray[1] == "PDF" OR $namearray[1] == "docx" OR $namearray[1] == "DOCX" OR $namearray[1] == "doc" OR $namearray[1] == "DOC" OR $namearray[1] == "php" OR $namearray[1] == "PHP" OR $namearray[1] == "html" OR $namearray[1] == "HTML" OR $namearray[1] == "css" OR $namearray[1] == "CSS" OR $namearray[1] == "xlsx" OR $namearray[1] == "XLSX" OR $namearray[1] == "xls" OR $namearray[1] == "XLS" OR $namearray[1] == "ppt" OR $namearray[1] == "PPT" OR $namearray[1] == "pptx" OR $namearray[1] == "PPTX" OR $namearray[1] == "txt" OR $namearray[1] == "TXT" OR $namearray[1] == "mp3" OR $namearray[1] == "MP3") {
        ...
        echo "Dateiart nicht zugelassen<br><br><a href=upload.php><button id='upload'>Zurück zum Upload</button></a><a href=index.php><button id='upload'>Zurück zur Startseite</button></a>";
        die();
    }
}
    ...
    if ($stmt->execute()) {
        ...
        echo "Upload erfolgreich<br><br><a href=upload.php><button id='upload'>Zurück zum Upload</button></a><a href=index.php><button id='upload'>Zurück zur Startseite</button></a>";
    }


if (!move_uploaded_file($_FILES["uploadfile"]["tmp_name"], "/home/ab247/public_html/s19_lima/files/".$namearray[0].".".$owner.".".$namearray[1])) {
    echo "Datei nicht hochgeladen<br><br><a href=upload.php><button id='upload'>Zurück zum Upload</button></a><a href=index.php><button id='upload'>Zurück zur Startseite</button></a>";
    die();
}
